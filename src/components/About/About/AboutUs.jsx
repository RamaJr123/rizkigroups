    ...
    <section id="about">
      <div className="container">
        <div className="row d-flex justify-content-center">
          <div className="col-md-12 animate__animated animate__bounce" data-aos="fade-up">
            ...
            <div className="text-1 animate__animated animate__bounce" data-aos="fade-up">
            ...
            <div className="text-2 pt-5 animate__animated animate__bounce" data-aos="fade-up">
            ...
            <div className="text-3 pt-5 animate__animated animate__bounce" data-aos="fade-up">
        ...
        <div className="row d-flex justify-content-center" style={{ marginTop: '150px' }}>
          <div className="col-md-6 animate__animated animate__bounce" data-aos="fade-up">
          ...
          <div className="col-md-6 animate__animated animate__bounce">
            <figure class="snip1336">
              <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/331810/sample87.jpg" alt="sample87" />
              <figcaption>
                <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/331810/profile-sample4.jpg" alt="profile-sample4" class="profile" />
